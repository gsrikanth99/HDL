...
class AssetObjectBuilder {
  ...
  //Date format as per XML data
	...
	/**
	 * Create case class object for AssetData from LinkedHashMap and List
	 * @param xmlMap : LinkedHashMap[String,String]
	 * @param xmlList : List[LinkedHashMap[String,String]]
	 * @param processId : String
	 * @return (AssetRecord, AuditRecord)
	 */
	def createAssetObject(xmlMap: LinkedHashMap[String,String], xmlList: List[LinkedHashMap[String,String]],processId : String) : (AssetRecord, AuditRecord) ={
    (AssetRecord(
